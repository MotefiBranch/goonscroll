...
try {
  ...
  try {
    execSync('git commit -m "Fix xcodebuild invocation to use App.xcodeproj for Capacitor 8 Swift Package Manager"', { stdio: 'inherit' });
  } catch (e) {}
  ...
  console.log('✔ Successfully pushed xcodebuild project fix to https://github.com/lalaliwe/goonscroll');
} catch (err) {
