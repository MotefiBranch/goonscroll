...
try {
  ...
  execSync('git commit -m "Support animated GIF playback in ImageViewer candidate pipeline"', { stdio: 'inherit' });
  ...
  console.log('✔ Successfully pushed GIF support to MotefiBranch/goonscroll!');
} catch (err) {
