...
try {
  ...
  try {
    execSync('git commit -m "Remove incompatible status-bar plugin to fix Xcode Swift compilation"', { stdio: 'inherit' });
  } catch (e) {}
  ...
  console.log('✔ Successfully pushed clean iOS project to https://github.com/lalaliwe/goonscroll');
} catch (err) {
